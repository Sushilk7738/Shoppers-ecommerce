...
import { registerAPI } from "../api/auth.api"; // single API layer
import { saveUserInfo } from "../utils/Auth"; // auth storage
...
function Signup() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // centralized signup call
            const data = await registerAPI(fullname, email, password);

            saveUserInfo(data); // persist session
            dispatch(loginSuccess(data)); // update redux
