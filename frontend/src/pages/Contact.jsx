...
const Contact = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await contactAPI.sendMessage(formData); // api call
                    ...
                    <div className="animate__animated animate__fadeInLeft">
                        <div className="relative">
                            ...
                            <div className="relative bg-white rounded-3xl border border-cyan-100 shadow-lg overflow-hidden">
                                <img
                                    src="https://res.cloudinary.com/dcgsyosjx/image/upload/v1767019486/contact1_d16whl.jpg"
                            ...
                            >
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm focus:ring-2 focus:ring-cyan-500"
                                    />
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        onChange={handleChange}
                                        className="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm resize-none focus:ring-2 focus:ring-cyan-500"
                                    />
                                </div>
