...
const Checkout = () => {
    ...
    const verifyPayment = useCallback(
        async (response) => {
            ...
            try {
                const data = await orderAPI.verifyPayment(paymentData);
        ...
        [cartTotal, form, cart, dispatch, navigate, showToast]
    );
    ...
    const createOrder = async () => {
        ...
        try {
            const order = await orderAPI.createOrder(cartTotal);
            openRazorpay(order);
        } catch {
